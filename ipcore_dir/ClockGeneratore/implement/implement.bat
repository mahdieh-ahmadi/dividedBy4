...
xst -ifn xst.scr
move ClockGeneratore_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ClockGeneratore_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ClockGeneratore_exdes.ucf ClockGeneratore_exdes

echo 'Running map'
map -timing -pr b ClockGeneratore_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ClockGeneratore_exdes -w routed.ncd routed.v
cd ..
